...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-950 to-black text-gray-200">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-slate-900/80 backdrop-blur-md border-b border-gray-700 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-purple-700 bg-clip-text text-transparent">
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'Projects', 'Skills', 'Education', 'Certifications', 'Interests', 'Contact'].map((item) => (
                <button
                  ...
                  className={`text-sm font-medium transition-colors hover:bg-gradient-to-r hover:from-purple-500 hover:to-purple-700 hover:bg-clip-text hover:text-transparent ${
                    activeSection === item.toLowerCase() ? 'bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent' : 'text-gray-300'
                  }`}
                >
                  {item}
                </button>
            ...
            <div className="px-4 py-4 space-y-3">
              {['Home', 'Projects', 'Skills', 'Education', 'Certifications', 'Interests', 'Contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item.toLowerCase())}
                  className="block w-full text-left text-gray-200 hover:bg-gradient-to-r hover:from-purple-500 hover:to-purple-700 hover:bg-clip-text hover:text-transparent transition-colors"
                >
                  {item}
                </button>
              ))}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              <span className="bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">Full-Stack </span>
              <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">Developer</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a
                href={'https://drive.google.com/file/d/1EBMGqUPyE8CLvcfPJiNSeEiW4U-iEMoD/view?usp=drive_link'}
                target="_blank"
                rel="noopener noreferrer"
                className="border-2 border-purple-600 hover:bg-purple-900/20 bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent px-8 py-3 rounded-lg font-medium transition-colors flex items-center gap-2 justify-center"
              >
          ...
          >
            <div className="relative">
              <div className="w-80 h-80 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full p-1">
                <img
                  src="https://res.cloudinary.com/dozb1abfn/image/upload/v1758891657/WhatsApp_Image_2025-09-22_at_1.34.56_AM_1_q2z1lb.jpg"
                  alt="Keren Hapuch"
                  className="w-full h-full object-cover rounded-full"
                />
              </div>
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-slate-900/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-gray-700">
                <p className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent text-sm font-medium">AI Enthusiast</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section id="projects" className="py-20 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-center mb-16">
            <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">My Projects</span>
          </h2>
          <div className="flex flex-row overflow-x-auto gap-x-6 pb-4 hide-scrollbar">
            {portfolioData.projects.map((project, index) => (
              <motion.div
                key={index}
                className="bg-slate-800 border border-gray-700 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-purple-700 min-w-[320px] max-w-[320px] flex-shrink-0"
                initial={{ opacity: 0, y: 40 }}
              ...
              >
                ...
                {project.imageUrl && (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                      <div className="bg-slate-900/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg border border-gray-700">
                        <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent font-medium flex items-center gap-2">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="text-xl font-semibold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">{project.title}</h3>
                    <a
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag, tagIndex) => (
                      <span
                        key={tagIndex}
                        className="bg-purple-900/30 text-purple-300 px-3 py-1 rounded-full text-sm border border-purple-700"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent hover:from-purple-400 hover:to-purple-600 transition-colors flex items-center gap-2 font-medium"
                  >
      ...
      <section id="skills" className="py-20 px-4 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-center mb-16">
            <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">My Tech Stack</span>
          </h2>
          <motion.div
          ...
          >
            {portfolioData.skills.languages.map((skill, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-purple-700 rounded-xl p-6 hover:shadow-lg hover:border-purple-600 transition-all">
                  <Code className="text-purple-400 mx-auto mb-3" size={32} />
                  <span className="bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent font-medium">{skill}</span>
                </div>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <motion.div
              className="bg-gradient-to-br from-slate-900 to-slate-800 border border-purple-700 rounded-xl p-6 shadow-sm"
              variants={{ hidden: { opacity: 0, y: 30 }, show: { opacity: 1, y: 0 } }}
              transition={{ duration: 0.5 }}
            >
              <div className="flex items-center gap-3 mb-6">
                <Terminal className="text-purple-400" size={24} />
                <h3 className="text-xl font-semibold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">Development Tools</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">Other Skills</h3>
              </div>
              <div className="flex flex-wrap gap-3">
      ...
      {/* Education Section */}
      <section id="education" className="py-20 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-center mb-16">
            <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">My Education</span>
          </h2>
          <motion.div
            className="space-y-8"
            variants={{
          ...
          >
            {portfolioData.education.map((edu, index) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent mb-2">{edu.institution}</h3>
      ...
      {/* Interests Section */}
      <section id="interests" className="py-20 px-4 bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-center mb-16">
            <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">Tech Interests</span>
          </h2>
          <div className="flex flex-row overflow-x-auto gap-x-6 mb-12 hide-scrollbar">
            {portfolioData.interests.map((interest, index) => (
              <div key={index} className="bg-gradient-to-br from-slate-900 to-slate-800 border border-purple-700 rounded-xl p-6 text-center hover:shadow-lg hover:border-purple-600 transition-all min-w-[260px] max-w-[260px] flex-shrink-0">
                <div className="bg-purple-900/30 p-4 rounded-lg inline-block mb-4 border border-purple-700">
                ...
                <h3 className="text-lg font-semibold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent mb-3">{interest.title}</h3>
                <p className="text-gray-300">{interest.description}</p>
              </div>
            ))}
          </div>
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-purple-700 rounded-xl p-8 text-center shadow-sm">
            <h3 className="text-2xl font-semibold bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent mb-4">Always Learning & Exploring</h3>
      ...
      <section id="contact" className="py-20 px-4 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-8">
            <span className="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">Get In Touch</span>
          </h2>
          ...
          <div className="flex justify-center gap-6 mb-12">
            ...
            >
                ...
                {social.platform === 'GitHub' && <Github className="text-gray-200 w-6 h-6" />}
                {social.platform === 'Email' && <Mail className="text-purple-400 w-6 h-6" />}
              </motion.a>
            ))}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.a
              ...
              className="bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-500 hover:to-purple-700 text-white px-8 py-3 rounded-lg font-medium transition-all flex items-center gap-2 justify-center shadow-lg"
            >
              <Mail size={18} />
          ...
          {/* Review Form */}
          <motion.div
            className="mt-16 max-w-xl mx-auto bg-slate-800 rounded-xl shadow-lg p-8 border border-purple-700"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">Leave a Review</h3>
            <ReviewForm />
          </motion.div>
